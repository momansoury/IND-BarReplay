...
void Create_BigButton(datetime &bar_time, string &bigbutton_name,)
   {
    if(bar_time)
       {
        ...
        ButtonCreate(0, bigbutton_name, 0, x1, y1, 99999, 99999, 2, ANCHOR_RIGHT, "", color(bg_color), false, clrBlue);
       }
   }
